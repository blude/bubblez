<!--
Sync Impact Report:
Version change: 1.0.0 → 1.1.0 (MINOR - added educational context and constructivist learning principles)
Modified principles: 
- Added "Learning-First Development" principle
- Enhanced "Pedagogical Objectives" section with specific learner context
Added sections:
- Learner Context & Background
- Constructivist Learning Approach
- Skill Development Path
Templates requiring updates: ✅ plan-template.md, ✅ spec-template.md, ✅ tasks-template.md (all aligned with educational focus)
Follow-up TODOs: None
-->

# Bubblez Constitution
...
- Use tests to validate learning and understanding
